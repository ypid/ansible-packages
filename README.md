...
* [Linux based systems for schools](https://github.com/ypid/ansible-linuxmuster_net-client-customize)
* Live systems

### History

Before I knew Ansible, I had a shell script which asked you which
categories you wanted to install.
